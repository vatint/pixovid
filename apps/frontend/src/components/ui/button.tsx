...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold tracking-wide transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_0_20px_-4px_oklch(0.72_0.16_250/0.55)] hover:bg-primary/90 hover:shadow-[0_0_28px_-2px_oklch(0.78_0.14_245/0.7)]",
        destructive:
          "bg-destructive text-destructive-foreground shadow-[0_0_16px_-4px_oklch(0.62_0.22_25/0.5)] hover:bg-destructive/90",
        outline:
          "border border-primary/35 bg-primary/5 text-foreground hover:bg-primary/10 hover:border-primary/60 hover:shadow-[0_0_16px_-6px_oklch(0.72_0.16_250/0.4)]",
        secondary:
      ...
      size: {
        ...
        sm: "h-8 rounded-full px-4 text-xs tracking-wider uppercase font-hud",
        lg: "h-12 rounded-full px-8 font-display text-[0.95rem] tracking-wider",
